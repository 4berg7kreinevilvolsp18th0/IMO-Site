        ...
        <div className="glass-card p-6 sm:p-8 mb-10">
          ...
          <address className="not-italic space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="text-xs text-white/40 font-heading tracking-wider mb-0.5">EMAIL</div>
                <a
                  href={`mailto:${sc.contacts.email}`}
                  className="text-sm text-imo-sky hover:underline"
                >
                  {sc.contacts.email}
                </a>
              </div>
            ...
            <div className="flex items-start gap-4">
              <span className="text-xl flex-shrink-0" aria-hidden="true">🏢</span>
              <div>
                <div className="text-xs text-white/40 font-heading tracking-wider mb-0.5">КАБИНЕТ</div>
            ...
            <div className="flex items-start gap-4">
              <span className="text-xl flex-shrink-0" aria-hidden="true">🕐</span>
              <div>
                <div className="text-xs text-white/40 font-heading tracking-wider mb-0.5">ЧАСЫ РАБОТЫ</div>
